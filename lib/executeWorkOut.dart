...
class ExecuteWorkoutPage extends StatefulWidget {
  /// Default Constructor
  const ExecuteWorkoutPage({super.key});

  @override
  ExecuteWorkoutPageState createState() {
    return ExecuteWorkoutPageState();
  }
}
...
class ExecuteWorkoutPageState extends State<ExecuteWorkoutPage>
      ...
      Column(
        children: [
          Row(
            ...
            children: [
              Text("Strength Gauge",style: TextStyle(fontSize: 22,color: Colors.white,fontWeight: FontWeight.bold),),
              Spacer(),
              IconButton(
                onPressed: (){
                  setState(() {
          ...
          Row(children: [
            Text("Romanian DeadLift",style:TextStyle(fontSize: 22,color: Colors.white,fontWeight: FontWeight.bold) ,),
          ],),
          (startCamera?
          Container(
            height:400,
                ...
                Column(
                  children: [
                        ...
                        Column(
                          children: [
                            ...
                            Container(
                              ...
                              Text("Session Time",style: TextStyle(color: Colors.white,fontSize: 18),),),),
                            Padding(padding: EdgeInsets.only(top: 5),child:
                              Text("00:00:00",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),),),
                          ],
                        ),
                        Spacer(),
                        Column(
                          children: [
                            Container(
                              ...
                              child: Padding(padding: EdgeInsets.only(top: 5,bottom: 5,left: 15,right: 15),child:
                              Text("Active Time",style: TextStyle(color: Colors.white,fontSize: 18),),),),
                            Padding(padding: EdgeInsets.only(top: 5),child:
                              Text("00:00:00",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),),),
                          ],
                        ),
                    ...
                    /*Row(
                      children: [
                        Container(
                          child: Padding(padding: EdgeInsets.only(top: 5,left: 20),child:
                          Text("00:00:00",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),),),),
                        Spacer(),
                        Container(
                          child: Padding(padding: EdgeInsets.only(top: 5,left: 10,right: 10),child:
                          Text("00:00:00",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),),),),
                        //Container(child: Text("Active Time",style: TextStyle(color: Colors.white,fontSize: 18),)),
                      ],
                    ),*/
                    SizedBox(height: 20,),
                    Row(
                        ...
                        Column(
                          children: [
                            Container(
                              ...
                              child: Padding(padding: EdgeInsets.only(top:2,bottom: 2,left: 5,right: 5),child:
                              Text("Weight Mode",style: TextStyle(color: Colors.white,fontSize: 18),),),),
                            Container(
                        ...
                        Column(
                          children: [
                            Container(
                              ...
                              child: Padding(padding: EdgeInsets.only(top:2,bottom: 2,left: 5,right: 5),child:
                              Text("Assist Mode",style: TextStyle(color: Colors.white,fontSize: 18),),),),
                            Container(
                              margin: EdgeInsets.only(top: 5),
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(100.0),
                                gradient: LinearGradient(colors: [Colors.grey, Colors.white30]),
                              ...
                              child: Padding(padding: EdgeInsets.only(top: 2,bottom: 2,left: 5,right: 5),child:
                              Text("Spotter-1",style: TextStyle(color: Colors.white,fontSize: 18),),),),
                          ],
                        ),
                      ],
                    ),
                      ...
                      children: [
                        Column(
                          children: [
                              ...
                              Row(
                                children: [
                                  Container(width: 50,height: 20,
                                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(100.0),
                                      color: Colors.red,
                                      //gradient: LinearGradient(colors: [Colors.red, Colors.white30]),
                                      //boxShadow: [BoxShadow(blurRadius: 5, color: Colors.white70, offset: Offset(2, 2))],
                                    ),
                                  ),
                                  Spacer(),
                            ...
                            Padding(padding: EdgeInsets.only(top: 3,left: 5),child:
                              Row(children: [
                                Text("Sets  ",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                                Text("1",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),),
                                Text("  of  ",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                                Text("3",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),),
                              ],),
                              ),
                          ],
                        ),
                        ...
                        Column(
                          children: [
                            ...
                            Padding(padding: EdgeInsets.only(top: 3),child:
                              Row(children: [
                                Text("Reps  ",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                                Text("1",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),),
                                Text("  of  ",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                                Text("3",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),),
                              ],),
                    ...
                    /*Row(
                      children: [
                        Container(
                          child: Padding(padding: EdgeInsets.only(top: 5,bottom: 5,left: 15),child:
                              Row(children: [
                                Text("Sets  ",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                                Text("1",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),),
                                Text("  of  ",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                        ...
                        Spacer(),
                        Container(
                          child: Padding(padding: EdgeInsets.only(top: 5,bottom: 5,right: 10),child:
                          Row(children: [
                            Text("Reps  ",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                            Text("1",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),),
                            Text("  of  ",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          children: [
                            Container(width: 100,height: 50,decoration: BoxDecoration(color: Colors.white,boxShadow: [BoxShadow(color: Colors.white60,offset: Offset(2,2))],borderRadius: BorderRadius.all(Radius.circular(10))),
                              child: Center(child:Text("52 KG",style: TextStyle(fontSize: 18,color: Colors.black),)),
                            ),
                            Padding(padding: EdgeInsets.only(top: 5),child:
                              Text("Personal Best",style: TextStyle(fontSize: 18,color: Colors.white),),
                            ),
                          ],
                        ),
                        Column(
                          children: [
                            Container(width: 100,height: 50,decoration: BoxDecoration(color: Colors.white,boxShadow: [BoxShadow(color: Colors.white60,offset: Offset(2,2))],borderRadius: BorderRadius.all(Radius.circular(10))),
                              child: Center(child:Text("45 KG",style: TextStyle(fontSize: 18,color: Colors.black),)),
                            ),
                            Padding(padding: EdgeInsets.only(top: 5),child:
                              Text("Peak Load",style: TextStyle(fontSize: 18,color: Colors.white),),
                            ),
                          ],
                        )
                    ],),
